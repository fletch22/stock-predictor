...
from seq2seq.dataset.SymbolDataset import SymbolDataset
from seq2seq.training import train, evaluate
from seq2seq.models.seq2seq import Seq2Seq
from torch.utils import data
from seq2seq.seq_utils.data_generator import ToyDataset, pad_collate
...
def run():
    ...
    config_path = os.path.join(constants.PROJECT_DIR, "seq2seq", "experiments", FLAGS.config)
    ...
    dataset = SymbolDataset("GOOG", 2)
    eval_dataset = SymbolDataset("GOOG", 2)
    BATCHSIZE = 30
